...
When we say someone is _evil_, we usually mean they're on the _other side_. Recall that altruistic punishment is part of what allowed large-scale cooperation to flourish. This requires a [threat to defend against](https://www.pnas.org/content/pnas/110/41/16384.full.pdf). Given that humans are social animals, our primary motivators are social. Every social system co-opts this motivation to persist. Since we're not as inclined to attack as we are to defend our loved ones, the concept of Evil allows us to justify attacks against other groups by claiming every attack as an act of defense.
